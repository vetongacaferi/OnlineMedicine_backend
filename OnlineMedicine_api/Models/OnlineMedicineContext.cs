...
{
    public partial class OnlineMedicineContext : DbContext
    {
        public OnlineMedicineContext()
        {
        }
...
//                optionsBuilder.UseSqlServer("Server=(localdb)\\ProjectsV13;Database=OnlineMedicine;Trusted_Connection=True;");
//            }
        }
